...
#define PIO_INSTR(_opc, _delay, _sideSet, _misc) \
    (((_opc) << 13) | ((_sideSet) << (13 - SIDE_SET_BITS_USED)) | ((_delay) << 8) | (_misc))
#define I_JMP(_delay, _sideSet, _condition, _dst) PIO_INSTR(0x00, _delay, _sideSet, (((_condition) << 5) | (_dst)))
#define I_WAIT(_delay, _sideSet, _polarity, _src, _idx) \
    PIO_INSTR(0x01, _delay, _sideSet, (((_polarity) << 7) | ((_src) << 5) | (_idx)))
...
#define I_MOV(_delay, _sideSet, _dst, _op, _src) \
    PIO_INSTR(0x05, _delay, _sideSet, (((_dst) << 5) | ((_op) << 3) | (_src)))
#define I_IRQ(_delay, _sideSet, _clr, _wait, _idx) \
    PIO_INSTR(0x06, _delay, _sideSet, (((_clr) << 6) | ((_wait) << 5) | (_idx)))
