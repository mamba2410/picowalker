#ifndef PW_DRIVER_EEPROM_EMULATED_H
#define PW_DRIVER_EEPROM_EMULATED_H
...
int pw_eeprom_read_flash_direct(pw_eeprom_addr_t addr, uint8_t *buf, size_t len);
...
#endif /* PW_DRIVER_EEPROM_EMULATED_H */