...
#define REG_CHARGE_CONTROL_TOPOFF_TMR_MSK                 (0x03 << 3)
#define REG_CHARGE_CONTROL_TOPOFF_TMR_DISABLED            (0x00 << 3)
#define REG_CHARGE_CONTROL_TOPOFF_TMR_17MINS              (0x01 << 3)
#define REG_CHARGE_CONTROL_TOPOFF_TMR_35MINS              (0x02 << 3)
#define REG_CHARGE_CONTROL_TOPOFF_TMR_52MINS              (0x03 << 3)
...
#define REG_CHARGER_CONTROL_0_WATCHDOG_MSK                (0x03 << 0)
#define REG_CHARGER_CONTROL_0_WATCHDOG_DISABLED           (0x00 << 0)
#define REG_CHARGER_CONTROL_0_WATCHDOG_50SEC              (0x01 << 0)
#define REG_CHARGER_CONTROL_0_WATCHDOG_100SEC             (0x02 << 0)
#define REG_CHARGER_CONTROL_0_WATCHDOG_200SEC             (0x03 << 0)
...
#define REG_CHARGER_CONTROL_1_SET_CONV_STRN_MSK           (0x03 << 2)
#define REG_CHARGER_CONTROL_1_SET_CONV_STRN_WEAK          (0x00 << 2)
#define REG_CHARGER_CONTROL_1_SET_CONV_STRN_NORMAL        (0x01 << 2)
#define REG_CHARGER_CONTROL_1_SET_CONV_STRN_RESERVED      (0x02 << 2)
#define REG_CHARGER_CONTROL_1_SET_CONV_STRN_STRONG        (0x03 << 2)
#define REG_CHARGER_CONTROL_1_SET_CONV_FREQ_MSK           (0x03 << 4)
#define REG_CHARGER_CONTROL_1_SET_CONV_FREQ_1_50MHZ       (0x00 << 4)
#define REG_CHARGER_CONTROL_1_SET_CONV_FREQ_1_35MHZ       (0x01 << 4)
#define REG_CHARGER_CONTROL_1_SET_CONV_FREQ_1_65MHZ       (0x02 << 4)
#define REG_CHARGER_CONTROL_1_SET_CONV_FREQ_RESERVED      (0x03 << 4)
...
#define REG_CHARGER_CONTROL_2_BATFET_CTRL_MSK             (0x03 << 0)
#define REG_CHARGER_CONTROL_2_BATFET_CTRL_NORMAL          (0x00 << 0)
#define REG_CHARGER_CONTROL_2_BATFET_CTRL_SHUTDOWN        (0x01 << 0)
#define REG_CHARGER_CONTROL_2_BATFET_CTRL_SHIP            (0x02 << 0)
#define REG_CHARGER_CONTROL_2_BATFET_CTRL_SYS_PWR_RST     (0x03 << 0)
...
#define REG_CHARGER_CONTROL_3_CHG_RATE_MSK                (0x03 << 0)
#define REG_CHARGER_CONTROL_3_CHG_RATE_1C                 (0x00 << 0)
#define REG_CHARGER_CONTROL_3_CHG_RATE_2C                 (0x01 << 0)
#define REG_CHARGER_CONTROL_3_CHG_RATE_4C                 (0x02 << 0)
#define REG_CHARGER_CONTROL_3_CHG_RATE_6C                 (0x03 << 0)
...
#define REG_CHARGER_CONTROL_3_IBAT_PK_MSK                 (0x03 << 6)
#define REG_CHARGER_CONTROL_3_IBAT_PK_1_5A                (0x00 << 6)
#define REG_CHARGER_CONTROL_3_IBAT_PK_3A                  (0x01 << 6)
#define REG_CHARGER_CONTROL_3_IBAT_PK_6A                  (0x02 << 6)
#define REG_CHARGER_CONTROL_3_IBAT_PK_12A                 (0x03 << 6)
#define REG_NTC_CONTROL_0_TS_ISET_COOL_MSK                (0x03 << 0)
#define REG_NTC_CONTROL_0_TS_ISET_COOL_SUSP               (0x00 << 0)
#define REG_NTC_CONTROL_0_TS_ISET_COOL_20PCT              (0x01 << 0)
#define REG_NTC_CONTROL_0_TS_ISET_COOL_40PCT              (0x02 << 0)
#define REG_NTC_CONTROL_0_TS_ISET_COOL_UNCHANGED          (0x03 << 0)
#define REG_NTC_CONTROL_0_TS_ISET_WARM_MSK                (0x03 << 2)
#define REG_NTC_CONTROL_0_TS_ISET_WARM_SUSP               (0x00 << 2)
#define REG_NTC_CONTROL_0_TS_ISET_WARM_20PCT              (0x01 << 2)
#define REG_NTC_CONTROL_0_TS_ISET_WARM_40PCT              (0x02 << 2)
#define REG_NTC_CONTROL_0_TS_ISET_WARM_UNCHANGED          (0x03 << 2)
...
#define REG_NTC_CONTROL_1_TS_VSET_WARM_MSK                (0x03 << 0)
#define REG_NTC_CONTROL_1_TS_VSET_WARM_300MV              (0x00 << 0)
#define REG_NTC_CONTROL_1_TS_VSET_WARM_200MV              (0x01 << 0)
#define REG_NTC_CONTROL_1_TS_VSET_WARM_100MV              (0x02 << 0)
#define REG_NTC_CONTROL_1_TS_VSET_WARM_UNCHANGED          (0x03 << 0)
#define REG_NTC_CONTROL_1_TS_TH456(x)                     (((x) & 0x07) << 2)
#define REG_NTC_CONTROL_1_TS_TH123(x)                     (((x) & 0x07) << 5)
#define REG_NTC_CONTROL_2_TS_ISET_PRECOOL_MSK             (0x03 << 0)
#define REG_NTC_CONTROL_2_TS_ISET_PRECOOL_SUSP            (0x00 << 0)
#define REG_NTC_CONTROL_2_TS_ISET_PRECOOL_20PCT           (0x01 << 0)
#define REG_NTC_CONTROL_2_TS_ISET_PRECOOL_40PCT           (0x02 << 0)
#define REG_NTC_CONTROL_2_TS_ISET_PRECOOL_UNCHANGED       (0x03 << 0)
#define REG_NTC_CONTROL_2_TS_ISET_PREWARM_MSK             (0x03 << 2)
#define REG_NTC_CONTROL_2_TS_ISET_PREWARM_SUSP            (0x00 << 2)
#define REG_NTC_CONTROL_2_TS_ISET_PREWARM_20PCT           (0x01 << 2)
#define REG_NTC_CONTROL_2_TS_ISET_PREWARM_40PCT           (0x02 << 2)
#define REG_NTC_CONTROL_2_TS_ISET_PREWARM_UNCHANGED       (0x03 << 2)
#define REG_NTC_CONTROL_2_TS_VSET_PREWARM_MSK             (0x03 << 4)
#define REG_NTC_CONTROL_2_TS_VSET_PREWARM_300MV           (0x00 << 4)
#define REG_NTC_CONTROL_2_TS_VSET_PREWARM_200MV           (0x01 << 4)
#define REG_NTC_CONTROL_2_TS_VSET_PREWARM_100MV           (0x02 << 4)
#define REG_NTC_CONTROL_2_TS_VSET_PREWARM_UNCHANGED       (0x03 << 4)
...
#define REG_CHARGER_STATUS_1_CHG_STAT_MSK                 (0x03 << 3)
#define REG_CHARGER_STATUS_1_CHG_STAT_NOT_CHG             (0x00 << 3)
#define REG_CHARGER_STATUS_1_CHG_STAT_CC_CHG              (0x01 << 3)
#define REG_CHARGER_STATUS_1_CHG_STAT_CV_CHG              (0x02 << 3)
#define REG_CHARGER_STATUS_1_CHG_STAT_TOP_OFF_CHG         (0x03 << 3)
...
#define REG_ADC_CONTROL_ADC_SAMPLE_MSK                    (0x03 << 4)
#define REG_ADC_CONTROL_ADC_SAMPLE_12_BIT                 (0x00 << 4)
#define REG_ADC_CONTROL_ADC_SAMPLE_11_BIT                 (0x01 << 4)
#define REG_ADC_CONTROL_ADC_SAMPLE_10_BIT                 (0x02 << 4)
#define REG_ADC_CONTROL_ADC_SAMPLE_9_BIT                  (0x03 << 4)
